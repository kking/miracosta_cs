...
class Intervals 
{
	...
	public Intervals()
	{
		isDiatonic = false; // Therefore chromatic
		loadFiles();
	}
	...
	private void loadFiles()
	{
		...
		// the major scale.
		wavFiles.add(new IntervalWavFile(KEY, "P1", "audio/00_cUnison.wav")); 
		wavFiles.add(new IntervalWavFile(KEY, "M2", "audio/02_cMajorSecond.wav"));    
		wavFiles.add(new IntervalWavFile(KEY, "M3", "audio/04_cMajorThird.wav"));      
		wavFiles.add(new IntervalWavFile(KEY, "P4", "audio/05_cPerfectFourth.wav"));   
		wavFiles.add(new IntervalWavFile(KEY, "P5", "audio/07_cPerfectFifth.wav"));  
		wavFiles.add(new IntervalWavFile(KEY, "M6", "audio/09_cMajorSixth.wav"));      
		wavFiles.add(new IntervalWavFile(KEY, "M7", "audio/11_cMajorSeventh.wav"));  
		wavFiles.add(new IntervalWavFile(KEY, "P8", "audio/12_cUnison.wav"));
		...
		if (!(isDiatonic))
		{
			wavFiles.add(1, (new IntervalWavFile(KEY, "m2", "audio/01_cMinorSecond.wav"))); 
			wavFiles.add(3, (new IntervalWavFile(KEY, "m3", "audio/03_cMinorThird.wav"))); 
			wavFiles.add(6, (new IntervalWavFile(KEY, "A4", "audio/06_cTritone.wav")));  // represented as an A4 or d5
			wavFiles.add(8, (new IntervalWavFile(KEY, "m6", "audio/08_cMinorSixth.wav"))); 
			wavFiles.add(10, (new IntervalWavFile(KEY, "m7", "audio/10_cMinorSeventh.wav")));
		}
